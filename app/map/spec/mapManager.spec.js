describe('mapManager', function() {
  ...
  beforeEach(inject(function ($rootScope, $location, $q, _MapManager_,
                              _stateSvc_, _$httpBackend_) {
    q = $q;
  ...
  describe('getDataFromLocalServer', function() {
    ...
    it("should return `error` if endpoint doesn't exist", function() {
      ...
      MapManager.getDataFromLocalServer(15, 'annotations')
      .then(function(_res_) {
        res = _res_;
        console.log(_res_);
      });
  ...
  describe('loadMap', function() {
    it("should call `loadMapFromID`", function() {
      var loadMapFromIDSpy = spyOn(MapManager, 'loadMapFromID').and.callThrough();
