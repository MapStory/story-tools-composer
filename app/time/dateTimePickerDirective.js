  ...
  return {
    ...
    link: function(scope, element, attrs) {
      ...
      var updateDateTime = function()   {
        ...
        var date = null;
        if (goog.isDefAndNotNull(picker) && goog.isDefAndNotNull(picker.date())) {
          date = picker.date();
      ...
      var dateOptions = {
        ...
        format: (scope.time === 'true' && scope.seperateTime === 'false') ?
      ...
      var dateObjectChanged = function() {
        ...
        if (scope.date === 'true' && hasValidDate) {
          element.find('.datepicker').data('DateTimePicker').date(dateOptions.defaultDate);
        }
        if (scope.time === 'true' && (scope.seperateTime === 'true' || scope.date === 'false') && hasValidDate) {
          element.find('.timepicker').data('DateTimePicker').date(dateOptions.defaultDate);
        }
        updateDateTime();
      };
